...
#include "F:/C++/Camera/CamerasRevenge/smtp.h"
...
QT_MOC_LITERAL(7, 60, 28),
QT_MOC_LITERAL(8, 89, 11),
QT_MOC_LITERAL(9, 101, 13),
QT_MOC_LITERAL(10, 115, 28),
QT_MOC_LITERAL(11, 144, 11),
QT_MOC_LITERAL(12, 156, 12),
QT_MOC_LITERAL(13, 169, 9),
QT_MOC_LITERAL(14, 179, 9)
    },
    "smtp\0status\0\0complete\0buttonSend\0"
    "getAttachment\0stateChanged\0"
...
void smtp::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->complete((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 2: _t->buttonSend(); break;
        case 3: _t->getAttachment(); break;
        case 4: _t->stateChanged((*reinterpret_cast< QAbstractSocket::SocketState(*)>(_a[1]))); break;
        case 5: _t->errorReceived((*reinterpret_cast< QAbstractSocket::SocketError(*)>(_a[1]))); break;
        ...
        {
            typedef void (smtp::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&smtp::complete)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject smtp::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_smtp.data,
